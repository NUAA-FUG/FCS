...
cd ~/Downloads
wget -q --show-progress https://dl.google.com/dl/android/studio/ide-zips/3.1.2.0/android-studio-ide-173.4720617-linux.zip

# Unzip the package to /opt/ directory
sudo unzip android-studio-ide-173.4720617-linux.zip -d /opt/

sudo rm android-studio-ide-173.4720617-linux.zip 
